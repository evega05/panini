...
export default function Footer() {
  return (
    <footer style={{ background: '#0a0a0a', borderTop: '1px solid #1a1a1a', padding: '52px 48px 36px' }}>
      <div style={{ maxWidth: 1440, margin: '0 auto' }}>
        {/* Top row */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 24, flexWrap: 'wrap', marginBottom: 32 }}>
        ...
        {/* Legal links row */}
        <div style={{ borderTop: '1px solid #1a1a1a', paddingTop: 20, display: 'flex', gap: 24, flexWrap: 'wrap' }}>
          {[
            ...
            <Link
              key={to}
              to={to}
              style={{ fontSize: '.68rem', color: '#2a2a2a', textDecoration: 'none', fontFamily: "'Inter', sans-serif", transition: 'color .2s' }}
              onMouseEnter={e => (e.currentTarget.style.color = '#fff')}
